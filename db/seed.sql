...
SELECT '20000000-0000-0000-0000-000000000001'::uuid, id, '11111111-1111-1111-1111-111111111111'::uuid FROM roles WHERE name = 'admin'
UNION ALL
SELECT '20000000-0000-0000-0000-000000000002'::uuid, id, '11111111-1111-1111-1111-111111111111'::uuid FROM roles WHERE name = 'doctor'
UNION ALL
SELECT '20000000-0000-0000-0000-000000000003'::uuid, id, '11111111-1111-1111-1111-111111111111'::uuid FROM roles WHERE name = 'nurse'
UNION ALL
SELECT '20000000-0000-0000-0000-000000000004'::uuid, id, '11111111-1111-1111-1111-111111111111'::uuid FROM roles WHERE name = 'receptionist'
UNION ALL
SELECT '20000000-0000-0000-0000-000000000005'::uuid, id, '11111111-1111-1111-1111-111111111111'::uuid FROM roles WHERE name = 'patient'
